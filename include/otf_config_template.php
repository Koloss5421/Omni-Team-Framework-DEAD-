...
*/
## Database Connection
define("DBHOST", "InsertDatabaseHostHere");
define("DBUSER", "InsertDatabaseUserHere");
define("DBPASS", "InsertDatabasePasswordHere");
define("DBNAME", "InsertDatabaseNameHere");
## Global Settings
define("RIOTAPIKEY", "InsertRiotApiKeyHere");
define("RIOTREGION", "Ex. NA EU etc..");
?>
