	...
	$.fn.extend({
		...
		function setMonthly(m, y){
			...
			if (setMonth == currentMonth && setYear == currentYear) {
				...
				$('#' + uniqueId + ' .monthly-header-title').html('<a href="#" class="monthly-header-title-date"  onclick="return false">'+monthNames[m - 1] +' '+ y +'</a><a href="#" class="monthly-reset" title="Set to today"><span class="glyphicon glyphicon-repeat"></span> TODAY</a> ');
			}
		...
		function viewToggleButton(){
			if($('#'+uniqueId+' .monthly-event-list').is(":visible")) {
				...
				$('#'+uniqueId+' .monthly-header-title').prepend('<a href="#" class="monthly-cal" title="Back To Month View"><span class="glyphicon glyphicon-th"></span> MONTH</a>');
			}
		}
